...
const deploy = () => {
  ...
  // Step 4: Check if the build directory exists
  if (!fs.existsSync(buildDir)) {
    console.error(`Build directory does not exist: ${buildDir}`);
    process.exit(1);
  }

  // Step 5: Clean up the publish branch (but leave .git, .gitignore, and the build folder)
  ...
  // Step 6: Move the contents of the build folder to the root of the publish branch
  ...
  // Step 8: Commit and push the changes to the publish branch
